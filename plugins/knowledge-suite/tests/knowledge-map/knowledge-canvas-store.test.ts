...
import { KnowledgeMapStore } from '../../src/features/knowledge-map/data/store';
import type { KnowledgeMapData } from '../../src/features/knowledge-map/data/schema';
...
describe('knowledge canvas relationships', () => {
	it('persists and reuses a child canvas for the same parent and folder', async () => {
		...
		} as KnowledgeSuiteDataNamespace<KnowledgeMapData>;

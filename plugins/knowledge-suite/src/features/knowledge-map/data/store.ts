...
export class KnowledgeMapStore {
	...
	constructor(private readonly persistence: KnowledgeSuiteDataNamespace<KnowledgeMapData>) {}

	async load(): Promise<void> {
		this.data = migrateData(await this.persistence.loadData());
	}
	...
	private queueSave(): void {
		...
		this.saveTimer = window.setTimeout(() => {
			this.saveTimer = null;
			void this.persistence.saveData(this.data);
		}, 250);
	}

...
export default {
  ...
  LEGACY_PLUGIN_CONFLICT:
    "Knowledge Suite did not start because these legacy plugins are still enabled: {PLUGINS}. Disable them, then reload Obsidian or re-enable Knowledge Suite.",
  LEGACY_DATA_IMPORT_SUCCESS:
    "Knowledge Suite copied and imported legacy plugin data. The original data was left unchanged.",
  LEGACY_DATA_IMPORT_FAILED:
    "Knowledge Suite did not start because legacy data could not be backed up and imported safely. The original data was left unchanged.",
  KNOWLEDGE_MAP_INITIALIZATION_FAILED:
    "Knowledge Map features could not be initialized.",
  KNOWLEDGE_MAP_NOT_READY: "Knowledge Map features are not ready.",
  SEMANTIC_FILTER_CANVAS_TITLE: "Semantic filter canvas",
  SEMANTIC_FILTER_CANVAS_SUBTITLE: "Arrange read-only semantic units selected through their bound Markdown properties.",
  SEMANTIC_FILTER_CANVAS_ACTION_TITLE: "Semantic filter canvas",
  SEMANTIC_FILTER_CANVAS_ACTION_DESC: "Temporarily gather Markdown-backed units by tags and properties without changing any source canvas.",
  SEMANTIC_FILTER_CANVAS_ACTION_OPEN: "Open",
  SEMANTIC_FILTER_FILTER: "Filter",
  SEMANTIC_FILTER_CLEAR: "Clear",
  SEMANTIC_FILTER_OPEN_FILTER: "Set Markdown property filters",
  SEMANTIC_FILTER_RESET_LAYOUT: "Reset layout",
  SEMANTIC_FILTER_REFRESH: "Refresh semantic filter canvas",
  SEMANTIC_FILTER_SEARCH_PLACEHOLDER: "Search unit name or bound Markdown…",
  SEMANTIC_FILTER_RESULT_SUMMARY: "{MATCHED} shown · {LINKED} Markdown-backed · {UNBOUND} unbound units",
  SEMANTIC_FILTER_UNBOUND_DOCUMENT: "No bound Markdown",
  SEMANTIC_FILTER_UNAVAILABLE_SUMMARY: "{COUNT} unavailable bindings",
  SEMANTIC_FILTER_READ_ONLY: "Read-only · move whole units only",
  SEMANTIC_FILTER_NO_BOUND_TITLE: "No Markdown-backed units",
  SEMANTIC_FILTER_NO_BOUND_DESC: "Bind a semantic unit to a Markdown file before filtering it by document properties.",
  SEMANTIC_FILTER_NO_MATCH_TITLE: "No matching semantic units",
  SEMANTIC_FILTER_NO_MATCH_DESC: "Adjust the Markdown property filters or clear the search term.",
  SEMANTIC_FILTER_MODAL_TITLE: "Filter semantic units",
  SEMANTIC_FILTER_MODAL_DESC: "Filter only by tags and properties from each unit's bound Markdown file.",
  SEMANTIC_FILTER_MATCH_ALL: "Match all",
  SEMANTIC_FILTER_MATCH_ANY: "Match any",
  SEMANTIC_FILTER_UNIT_ARIA: "Read-only semantic unit: {NAME}",
  SEMANTIC_FILTER_PREVIEW_ERROR: "Preview unavailable",
  SEMANTIC_FILTER_QUERY_FAILED: "Unable to load semantic filter results.",
  SEMANTIC_FILTER_ZOOM_OUT: "Zoom out",
  SEMANTIC_FILTER_ZOOM_IN: "Zoom in",
  SEMANTIC_FILTER_ZOOM_RESET: "Reset zoom and position",
  SEMANTIC_FILTER_MARKDOWN_CHANGE: "Choose or change bound Markdown",
  SEMANTIC_FILTER_MARKDOWN_UNLINK: "Unlink bound Markdown",
  SEMANTIC_FILTER_MARKDOWN_UPDATED: "Now bound to “{PATH}”.",
  SEMANTIC_FILTER_MARKDOWN_UNLINKED: "Markdown unlinked; the document and canvas content were not changed.",
  SEMANTIC_FILTER_MARKDOWN_UPDATE_FAILED: "Unable to update the bound Markdown file.",
  SEMANTIC_UNIT_RENAME_ACTION: "Rename semantic unit",
  SEMANTIC_UNIT_RENAME_TITLE: "Rename semantic unit",
  SEMANTIC_UNIT_RENAME_FIELD: "Unit name",
  SEMANTIC_UNIT_RENAME_CONFIRM: "Save name",
  SEMANTIC_UNIT_RENAME_CANCEL: "Cancel",
  SEMANTIC_UNIT_RENAME_SUCCESS: "Semantic unit renamed to “{NAME}”.",
  SEMANTIC_UNIT_RENAME_FAILED: "Unable to rename the semantic unit.",
  SEMANTIC_UNIT_RENAME_DOUBLE_CLICK: "Double-click to rename “{NAME}”",
  ...
  ZOOM_MIN_DESC:
    "How far you can zoom out to fit more of a large 2D canvas on screen. Default: 5%; adjust here when needed.",
...
`,
  ...
  INSERT_INLINE_LATEX: "Insert inline formula at the text cursor",
};

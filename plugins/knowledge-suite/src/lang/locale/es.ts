...
export default {
  ...
  LEGACY_PLUGIN_CONFLICT:
    "Knowledge Suite no se inició porque estos plugins anteriores siguen habilitados: {PLUGINS}. Deshabilítalos y luego reinicia Obsidian o vuelve a habilitar Knowledge Suite.",
  LEGACY_DATA_IMPORT_SUCCESS:
    "Knowledge Suite copió e importó los datos de los plugins anteriores. Los datos originales no se modificaron.",
  LEGACY_DATA_IMPORT_FAILED:
    "Knowledge Suite no se inició porque no fue posible respaldar e importar de forma segura los datos anteriores. Los datos originales no se modificaron.",
  KNOWLEDGE_MAP_INITIALIZATION_FAILED:
    "No se pudieron inicializar las funciones de Knowledge Map.",
  KNOWLEDGE_MAP_NOT_READY: "Las funciones de Knowledge Map aún no están listas.",
  SEMANTIC_FILTER_CANVAS_TITLE: "Lienzo de filtro semántico",
  SEMANTIC_FILTER_CANVAS_SUBTITLE: "Organiza temporalmente unidades de solo lectura mediante las propiedades del Markdown vinculado.",
  SEMANTIC_FILTER_CANVAS_ACTION_TITLE: "Lienzo de filtro semántico",
  SEMANTIC_FILTER_CANVAS_ACTION_DESC: "Reúne unidades por etiquetas y propiedades de Markdown sin cambiar los lienzos de origen.",
  SEMANTIC_FILTER_CANVAS_ACTION_OPEN: "Abrir",
  SEMANTIC_FILTER_FILTER: "Filtrar",
  SEMANTIC_FILTER_CLEAR: "Limpiar",
  SEMANTIC_FILTER_OPEN_FILTER: "Configurar filtros de propiedades Markdown",
  SEMANTIC_FILTER_RESET_LAYOUT: "Restablecer diseño",
  SEMANTIC_FILTER_REFRESH: "Actualizar el lienzo de filtro semántico",
  SEMANTIC_FILTER_SEARCH_PLACEHOLDER: "Buscar unidad o Markdown vinculado…",
  SEMANTIC_FILTER_RESULT_SUMMARY: "{MATCHED} visibles · {LINKED} vinculadas · {UNBOUND} sin vincular",
  SEMANTIC_FILTER_UNBOUND_DOCUMENT: "Sin Markdown vinculado",
  SEMANTIC_FILTER_UNAVAILABLE_SUMMARY: "{COUNT} vínculos no disponibles",
  SEMANTIC_FILTER_READ_ONLY: "Solo lectura · mover unidades completas",
  SEMANTIC_FILTER_NO_BOUND_TITLE: "No hay unidades vinculadas a Markdown",
  SEMANTIC_FILTER_NO_BOUND_DESC: "Vincula una unidad semántica a un archivo Markdown para filtrarla por propiedades.",
  SEMANTIC_FILTER_NO_MATCH_TITLE: "No hay unidades coincidentes",
  SEMANTIC_FILTER_NO_MATCH_DESC: "Ajusta los filtros de propiedades Markdown o borra la búsqueda.",
  SEMANTIC_FILTER_MODAL_TITLE: "Filtrar unidades semánticas",
  SEMANTIC_FILTER_MODAL_DESC: "Filtra solo por etiquetas y propiedades del Markdown vinculado a cada unidad.",
  SEMANTIC_FILTER_MATCH_ALL: "Cumplir todo",
  SEMANTIC_FILTER_MATCH_ANY: "Cumplir cualquiera",
  SEMANTIC_FILTER_UNIT_ARIA: "Unidad semántica de solo lectura: {NAME}",
  SEMANTIC_FILTER_PREVIEW_ERROR: "Vista previa no disponible",
  SEMANTIC_FILTER_QUERY_FAILED: "No se pudieron cargar los resultados del filtro semántico.",
  SEMANTIC_FILTER_ZOOM_OUT: "Alejar",
  SEMANTIC_FILTER_ZOOM_IN: "Acercar",
  SEMANTIC_FILTER_ZOOM_RESET: "Restablecer zoom y posición",
  SEMANTIC_FILTER_MARKDOWN_CHANGE: "Elegir o cambiar el Markdown vinculado",
  SEMANTIC_FILTER_MARKDOWN_UNLINK: "Desvincular Markdown",
  SEMANTIC_FILTER_MARKDOWN_UPDATED: "Ahora vinculado a «{PATH}».",
  SEMANTIC_FILTER_MARKDOWN_UNLINKED: "Markdown desvinculado; el documento y el lienzo no se modificaron.",
  SEMANTIC_FILTER_MARKDOWN_UPDATE_FAILED: "No se pudo actualizar el Markdown vinculado.",
  SEMANTIC_UNIT_RENAME_ACTION: "Cambiar nombre de la unidad semántica",
  SEMANTIC_UNIT_RENAME_TITLE: "Cambiar nombre de la unidad semántica",
  SEMANTIC_UNIT_RENAME_FIELD: "Nombre de la unidad",
  SEMANTIC_UNIT_RENAME_CONFIRM: "Guardar nombre",
  SEMANTIC_UNIT_RENAME_CANCEL: "Cancelar",
  SEMANTIC_UNIT_RENAME_SUCCESS: "La unidad semántica ahora se llama «{NAME}».",
  SEMANTIC_UNIT_RENAME_FAILED: "No se pudo cambiar el nombre de la unidad semántica.",
  SEMANTIC_UNIT_RENAME_DOUBLE_CLICK: "Haz doble clic para cambiar el nombre de «{NAME}»",
  ...
  ZOOM_MIN_DESC:
    "Hasta dónde se puede alejar el zoom para abarcar un lienzo 2D grande. Predeterminado: 5 %; ajústalo aquí cuando sea necesario.",
...
<a href="${URLs.WWW_YOUTUBE_COM_WATCH}" target="_blank"><img src="${URLs.I_YTIMG_COM_VI_P_Q6AVJGOWI_MAXRESDEFAULT_JPG}" style="width:100%;"></a>
  ...
  INSERT_INLINE_LATEX: "Insertar fórmula en línea en el cursor de texto",
};

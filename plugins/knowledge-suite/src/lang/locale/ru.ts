...
export default {
  ...
  LEGACY_PLUGIN_CONFLICT:
    "Knowledge Suite не запущен, потому что эти прежние плагины всё ещё включены: {PLUGINS}. Отключите их, затем перезапустите Obsidian или повторно включите Knowledge Suite.",
  LEGACY_DATA_IMPORT_SUCCESS:
    "Knowledge Suite скопировал и импортировал данные прежних плагинов. Исходные данные не изменены.",
  LEGACY_DATA_IMPORT_FAILED:
    "Knowledge Suite не запущен: не удалось безопасно создать резервную копию и импортировать прежние данные. Исходные данные не изменены.",
  KNOWLEDGE_MAP_INITIALIZATION_FAILED:
    "Не удалось инициализировать функции Knowledge Map.",
  KNOWLEDGE_MAP_NOT_READY: "Функции Knowledge Map ещё не готовы.",
  SEMANTIC_FILTER_CANVAS_TITLE: "Холст семантического фильтра",
  SEMANTIC_FILTER_CANVAS_SUBTITLE: "Временно размещайте единицы только для чтения по свойствам связанного Markdown.",
  SEMANTIC_FILTER_CANVAS_ACTION_TITLE: "Холст семантического фильтра",
  SEMANTIC_FILTER_CANVAS_ACTION_DESC: "Собирайте единицы по тегам и свойствам Markdown, не изменяя исходные холсты.",
  SEMANTIC_FILTER_CANVAS_ACTION_OPEN: "Открыть",
  SEMANTIC_FILTER_FILTER: "Фильтр",
  SEMANTIC_FILTER_CLEAR: "Очистить",
  SEMANTIC_FILTER_OPEN_FILTER: "Настроить фильтры свойств Markdown",
  SEMANTIC_FILTER_RESET_LAYOUT: "Сбросить раскладку",
  SEMANTIC_FILTER_REFRESH: "Обновить холст семантического фильтра",
  SEMANTIC_FILTER_SEARCH_PLACEHOLDER: "Поиск единицы или связанного Markdown…",
  SEMANTIC_FILTER_RESULT_SUMMARY: "Показано {MATCHED} · связанных с Markdown: {LINKED} · без привязки: {UNBOUND}",
  SEMANTIC_FILTER_UNBOUND_DOCUMENT: "Без привязки к Markdown",
  SEMANTIC_FILTER_UNAVAILABLE_SUMMARY: "Недоступных связей: {COUNT}",
  SEMANTIC_FILTER_READ_ONLY: "Только чтение · перемещение целых единиц",
  SEMANTIC_FILTER_NO_BOUND_TITLE: "Нет единиц, связанных с Markdown",
  SEMANTIC_FILTER_NO_BOUND_DESC: "Свяжите семантическую единицу с Markdown, чтобы фильтровать её по свойствам документа.",
  SEMANTIC_FILTER_NO_MATCH_TITLE: "Нет подходящих единиц",
  SEMANTIC_FILTER_NO_MATCH_DESC: "Измените фильтры свойств Markdown или очистите поиск.",
  SEMANTIC_FILTER_MODAL_TITLE: "Фильтр семантических единиц",
  SEMANTIC_FILTER_MODAL_DESC: "Фильтр использует только теги и свойства связанного Markdown-файла.",
  SEMANTIC_FILTER_MATCH_ALL: "Все условия",
  SEMANTIC_FILTER_MATCH_ANY: "Любое условие",
  SEMANTIC_FILTER_UNIT_ARIA: "Семантическая единица только для чтения: {NAME}",
  SEMANTIC_FILTER_PREVIEW_ERROR: "Предпросмотр недоступен",
  SEMANTIC_FILTER_QUERY_FAILED: "Не удалось загрузить результаты семантического фильтра.",
  SEMANTIC_FILTER_ZOOM_OUT: "Уменьшить",
  SEMANTIC_FILTER_ZOOM_IN: "Увеличить",
  SEMANTIC_FILTER_ZOOM_RESET: "Сбросить масштаб и позицию",
  SEMANTIC_FILTER_MARKDOWN_CHANGE: "Выбрать или заменить связанный Markdown",
  SEMANTIC_FILTER_MARKDOWN_UNLINK: "Отвязать Markdown",
  SEMANTIC_FILTER_MARKDOWN_UPDATED: "Теперь связан с «{PATH}».",
  SEMANTIC_FILTER_MARKDOWN_UNLINKED: "Markdown отвязан; документ и содержимое холста не изменены.",
  SEMANTIC_FILTER_MARKDOWN_UPDATE_FAILED: "Не удалось обновить связанный Markdown-файл.",
  SEMANTIC_UNIT_RENAME_ACTION: "Переименовать семантическую единицу",
  SEMANTIC_UNIT_RENAME_TITLE: "Переименовать семантическую единицу",
  SEMANTIC_UNIT_RENAME_FIELD: "Название единицы",
  SEMANTIC_UNIT_RENAME_CONFIRM: "Сохранить название",
  SEMANTIC_UNIT_RENAME_CANCEL: "Отмена",
  SEMANTIC_UNIT_RENAME_SUCCESS: "Семантическая единица переименована в «{NAME}».",
  SEMANTIC_UNIT_RENAME_FAILED: "Не удалось переименовать семантическую единицу.",
  SEMANTIC_UNIT_RENAME_DOUBLE_CLICK: "Дважды щёлкните, чтобы переименовать «{NAME}»",
...
`,
  ...
  INSERT_INLINE_LATEX: "Вставить встроенную формулу в позицию текстового курсора",
};

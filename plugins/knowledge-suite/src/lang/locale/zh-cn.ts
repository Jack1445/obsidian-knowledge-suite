...
export default {
  ...
  LEGACY_PLUGIN_CONFLICT:
    "Knowledge Suite 未启动，因为以下旧插件仍处于启用状态：{PLUGINS}。请先关闭这些插件，然后重新加载 Obsidian 或重新启用 Knowledge Suite。",
  LEGACY_DATA_IMPORT_SUCCESS:
    "Knowledge Suite 已复制并导入旧插件数据，原始数据保持不变。",
  LEGACY_DATA_IMPORT_FAILED:
    "Knowledge Suite 未启动，因为无法安全备份并导入旧插件数据。原始数据保持不变。",
  KNOWLEDGE_MAP_INITIALIZATION_FAILED: "无法初始化 Knowledge Map 功能。",
  KNOWLEDGE_MAP_NOT_READY: "Knowledge Map 功能尚未就绪。",
  SEMANTIC_FILTER_CANVAS_TITLE: "语义筛选画布",
  SEMANTIC_FILTER_CANVAS_SUBTITLE: "按绑定 Markdown 的标签与属性，临时整理只读语义单位。",
  SEMANTIC_FILTER_CANVAS_ACTION_TITLE: "语义筛选画布",
  SEMANTIC_FILTER_CANVAS_ACTION_DESC: "按 Markdown 标签与属性临时汇集语义单位，不修改任何来源画布。",
  SEMANTIC_FILTER_CANVAS_ACTION_OPEN: "打开",
  SEMANTIC_FILTER_FILTER: "筛选",
  SEMANTIC_FILTER_CLEAR: "清除",
  SEMANTIC_FILTER_OPEN_FILTER: "设置 Markdown 属性筛选条件",
  SEMANTIC_FILTER_RESET_LAYOUT: "整理布局",
  SEMANTIC_FILTER_REFRESH: "刷新语义筛选画布",
  SEMANTIC_FILTER_SEARCH_PLACEHOLDER: "搜索单位名称或绑定 Markdown…",
  SEMANTIC_FILTER_RESULT_SUMMARY: "显示 {MATCHED} 个 · {LINKED} 个 Markdown 依托单位 · {UNBOUND} 个无依托单位",
  SEMANTIC_FILTER_UNBOUND_DOCUMENT: "无依托 Markdown",
  SEMANTIC_FILTER_UNAVAILABLE_SUMMARY: "{COUNT} 个绑定暂不可用",
  SEMANTIC_FILTER_READ_ONLY: "只读 · 仅可整体移动",
  SEMANTIC_FILTER_NO_BOUND_TITLE: "还没有依托 Markdown 的语义单位",
  SEMANTIC_FILTER_NO_BOUND_DESC: "先为语义单位绑定 Markdown 文件，才能通过文档标签和属性筛选。",
  SEMANTIC_FILTER_NO_MATCH_TITLE: "没有符合条件的语义单位",
  SEMANTIC_FILTER_NO_MATCH_DESC: "请调整 Markdown 属性筛选条件，或清除搜索内容。",
  SEMANTIC_FILTER_MODAL_TITLE: "筛选画布语义单位",
  SEMANTIC_FILTER_MODAL_DESC: "仅筛选单位所绑定 Markdown 的标签与属性。",
  SEMANTIC_FILTER_MATCH_ALL: "满足全部",
  SEMANTIC_FILTER_MATCH_ANY: "满足任一",
  SEMANTIC_FILTER_UNIT_ARIA: "只读语义单位：{NAME}",
  SEMANTIC_FILTER_PREVIEW_ERROR: "暂时无法生成预览",
  SEMANTIC_FILTER_QUERY_FAILED: "无法加载语义筛选结果。",
  SEMANTIC_FILTER_ZOOM_OUT: "缩小",
  SEMANTIC_FILTER_ZOOM_IN: "放大",
  SEMANTIC_FILTER_ZOOM_RESET: "恢复缩放与位置",
  SEMANTIC_FILTER_MARKDOWN_CHANGE: "选择或更换依托 Markdown",
  SEMANTIC_FILTER_MARKDOWN_UNLINK: "解除依托 Markdown",
  SEMANTIC_FILTER_MARKDOWN_UPDATED: "已改为依托“{PATH}”。",
  SEMANTIC_FILTER_MARKDOWN_UNLINKED: "已解除依托 Markdown；文档与画布内容均未改动。",
  SEMANTIC_FILTER_MARKDOWN_UPDATE_FAILED: "无法更新依托 Markdown。",
  SEMANTIC_UNIT_RENAME_ACTION: "修改名称",
  SEMANTIC_UNIT_RENAME_TITLE: "修改元素单位名称",
  SEMANTIC_UNIT_RENAME_FIELD: "单位名称",
  SEMANTIC_UNIT_RENAME_CONFIRM: "保存名称",
  SEMANTIC_UNIT_RENAME_CANCEL: "取消",
  SEMANTIC_UNIT_RENAME_SUCCESS: "元素单位已重命名为“{NAME}”。",
  SEMANTIC_UNIT_RENAME_FAILED: "无法修改元素单位名称。",
  SEMANTIC_UNIT_RENAME_DOUBLE_CLICK: "双击修改“{NAME}”的名称",
  ...
  ZOOM_MIN_NAME: "最小缩放",
  ZOOM_MIN_DESC:
    "绘图缩小（显示更多内容）的极限。默认：5%，便于总览大型二维画布；仍可在此按需调整。",
  ZOOM_MAX_NAME: "最大缩放",
  ZOOM_MAX_DESC:
...
`,
  ...
  INSERT_INLINE_LATEX: "在文字光标处插入行内公式",
};

...
export default {
  ...
  LEGACY_PLUGIN_CONFLICT:
    "Knowledge Suite 未啟動，因為以下舊外掛仍處於啟用狀態：{PLUGINS}。請先停用這些外掛，然後重新載入 Obsidian 或重新啟用 Knowledge Suite。",
  LEGACY_DATA_IMPORT_SUCCESS:
    "Knowledge Suite 已複製並匯入舊外掛資料，原始資料保持不變。",
  LEGACY_DATA_IMPORT_FAILED:
    "Knowledge Suite 未啟動，因為無法安全備份並匯入舊外掛資料。原始資料保持不變。",
  KNOWLEDGE_MAP_INITIALIZATION_FAILED: "無法初始化 Knowledge Map 功能。",
  KNOWLEDGE_MAP_NOT_READY: "Knowledge Map 功能尚未就緒。",
  SEMANTIC_FILTER_CANVAS_TITLE: "語義篩選畫布",
  SEMANTIC_FILTER_CANVAS_SUBTITLE: "依綁定 Markdown 的標籤與屬性，暫時整理唯讀語義單位。",
  SEMANTIC_FILTER_CANVAS_ACTION_TITLE: "語義篩選畫布",
  SEMANTIC_FILTER_CANVAS_ACTION_DESC: "依 Markdown 標籤與屬性暫時彙集語義單位，不修改任何來源畫布。",
  SEMANTIC_FILTER_CANVAS_ACTION_OPEN: "開啟",
  SEMANTIC_FILTER_FILTER: "篩選",
  SEMANTIC_FILTER_CLEAR: "清除",
  SEMANTIC_FILTER_OPEN_FILTER: "設定 Markdown 屬性篩選條件",
  SEMANTIC_FILTER_RESET_LAYOUT: "整理版面",
  SEMANTIC_FILTER_REFRESH: "重新整理語義篩選畫布",
  SEMANTIC_FILTER_SEARCH_PLACEHOLDER: "搜尋單位名稱或綁定 Markdown…",
  SEMANTIC_FILTER_RESULT_SUMMARY: "顯示 {MATCHED} 個 · {LINKED} 個 Markdown 依託單位 · {UNBOUND} 個無依託單位",
  SEMANTIC_FILTER_UNBOUND_DOCUMENT: "無依託 Markdown",
  SEMANTIC_FILTER_UNAVAILABLE_SUMMARY: "{COUNT} 個綁定暫不可用",
  SEMANTIC_FILTER_READ_ONLY: "唯讀 · 僅可整體移動",
  SEMANTIC_FILTER_NO_BOUND_TITLE: "尚無依託 Markdown 的語義單位",
  SEMANTIC_FILTER_NO_BOUND_DESC: "先為語義單位綁定 Markdown 檔案，才能透過文件標籤和屬性篩選。",
  SEMANTIC_FILTER_NO_MATCH_TITLE: "沒有符合條件的語義單位",
  SEMANTIC_FILTER_NO_MATCH_DESC: "請調整 Markdown 屬性篩選條件，或清除搜尋內容。",
  SEMANTIC_FILTER_MODAL_TITLE: "篩選畫布語義單位",
  SEMANTIC_FILTER_MODAL_DESC: "僅篩選單位所綁定 Markdown 的標籤與屬性。",
  SEMANTIC_FILTER_MATCH_ALL: "符合全部",
  SEMANTIC_FILTER_MATCH_ANY: "符合任一",
  SEMANTIC_FILTER_UNIT_ARIA: "唯讀語義單位：{NAME}",
  SEMANTIC_FILTER_PREVIEW_ERROR: "暫時無法產生預覽",
  SEMANTIC_FILTER_QUERY_FAILED: "無法載入語義篩選結果。",
  SEMANTIC_FILTER_ZOOM_OUT: "縮小",
  SEMANTIC_FILTER_ZOOM_IN: "放大",
  SEMANTIC_FILTER_ZOOM_RESET: "恢復縮放與位置",
  SEMANTIC_FILTER_MARKDOWN_CHANGE: "選擇或更換依託 Markdown",
  SEMANTIC_FILTER_MARKDOWN_UNLINK: "解除依託 Markdown",
  SEMANTIC_FILTER_MARKDOWN_UPDATED: "已改為依託「{PATH}」。",
  SEMANTIC_FILTER_MARKDOWN_UNLINKED: "已解除依託 Markdown；文件與畫布內容均未改動。",
  SEMANTIC_FILTER_MARKDOWN_UPDATE_FAILED: "無法更新依託 Markdown。",
  SEMANTIC_UNIT_RENAME_ACTION: "修改名稱",
  SEMANTIC_UNIT_RENAME_TITLE: "修改元素單位名稱",
  SEMANTIC_UNIT_RENAME_FIELD: "單位名稱",
  SEMANTIC_UNIT_RENAME_CONFIRM: "儲存名稱",
  SEMANTIC_UNIT_RENAME_CANCEL: "取消",
  SEMANTIC_UNIT_RENAME_SUCCESS: "元素單位已重新命名為「{NAME}」。",
  SEMANTIC_UNIT_RENAME_FAILED: "無法修改元素單位名稱。",
  SEMANTIC_UNIT_RENAME_DOUBLE_CLICK: "按兩下以修改「{NAME}」的名稱",
  ...
  ZOOM_MIN_NAME: "最小縮放",
  ZOOM_MIN_DESC:
    "繪圖縮小（顯示更多內容）的極限。預設：5%，方便總覽大型二維畫布；仍可在此按需調整。",
  ZOOM_MAX_NAME: "最大縮放",
  ZOOM_MAX_DESC:
...
`,
  ...
  INSERT_INLINE_LATEX: "在文字游標處插入行內公式",
};

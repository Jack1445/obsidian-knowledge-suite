...
npm run test:suite     # 测试 Core 与 Knowledge Suite
npm run build:suite    # 构建 Core 和单一插件
...
- Obsidian 画布生命周期和文件交互修改 `plugins/knowledge-suite/src/core`。
- 文件夹语义、知识节点和地图管理修改 `plugins/knowledge-suite/src/features/knowledge-map`。
